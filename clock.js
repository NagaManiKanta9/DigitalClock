...
function bgImage(){
    ...
    var dy=date.getDay()
    console.log(dy)
    var arrImage=["sunday.jpg","monday.jpg","tuesday.jpg","wednesday.jpg","thursday.jpg","friday.jpg","saturday.jpg"]
    console.log(arrImage[dy])
    document.body.style.backgroundImage=`url(./Asset/${arrImage[dy]})`
}

var audio=new Audio("./Asset/clock-alarm-8761.mp3")
...
function userData(){
    ...
    if(currentddmmyy==userDate && currentTime==userTime)
    {
        // window.alert("Eh Babu Levv!!!!")
